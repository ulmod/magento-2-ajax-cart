...
* Enables ajax cart pop-up on any page
* No page reloads during add-to-cart process
* Support custom options. Ability to select custom options right at the popup without visiting the product page
* Support all product types
* Support related and cross-sell rght in the pop-up
* Flying Image Animation, when shoppers AJAX add an item to the cart
* Ability to update product quantity, right at the popup
* Support multistores
